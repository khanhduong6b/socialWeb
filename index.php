...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    {
    ?>
    <a href="./pages/register.php" class="w3-bar-item w3-button w3-hide-small w3-hide-medium w3-hover-white w3-right">Register</a> 
    <a href="./pages/login.php" class="w3-bar-item w3-button w3-hide-small w3-hide-medium w3-hover-white w3-right">Login</a>
    <?php
    } else {
...
<div class="w3-main" style="margin-left:250px">
  ...
  switch ($view) {
      case 'profile':
        ...
        else  echo '<div class="w3-row w3-padding-64">
